    ...
    for j in range(len(gold)):
        ...
        for i in range(len(predicted)):
            ...
            # Exceeding match
                ...
                # Check for overlap
                if (j + 1 < len(gold) and pred_end > gold[j + 1]['span'][0]) or ( # next gold start or previous gold end
                        j - 1 > 0 and pred_start < gold[j - 1]['span'][1]):
                    if not found_match:
                        score += 0
            ...
            # Partial match
                ...
                if (j + 1 < len(gold) and pred_end > gold[j + 1]['span'][0]) or ( # next gold start or previous gold end
                        j - 1 < 0 and pred_start < gold[j - 1]['span'][1]):
                        # next gold start or previous gold end
                        if not found_match:
                            score += 0
