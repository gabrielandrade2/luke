...
if __name__ == '__main__':
    ...
    for file in tqdm(glob.glob('/Users/gabriel-he/PycharmProjects/luke/data/entity_disambiguation/noise_generated/*/*'), desc='files'):
        iter = parse_conll_ner_data(file)
        filename = str(file).replace('noise_generated', 'noise_generated_fix')
