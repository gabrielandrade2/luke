...
if __name__ == '__main__':
    ...
    for noise_amount in [1]:
        for noise_ratio in [0.05, 0.1, 0.2, 0.3, 0.6, 1.0]:
            for file in ["/Users/gabriel-he/PycharmProjects/luke/data/entity_disambiguation/original_data/aida_train.txt",
                         "/Users/gabriel-he/PycharmProjects/luke/data/entity_disambiguation/original_data/testa_testb_aggregate_original"]:
                for i in tqdm(range(10)):
                    iter = parse_conll_ner_data(file)
                    os.makedirs('data/entity_disambiguation/noise_generated/noise_{}'.format(noise_ratio), exist_ok=True)
                    fout = open('data/entity_disambiguation/noise_generated/noise_{}/{}'.format(noise_ratio, file.split('/')[-1], i), 'w',
                                encoding='utf8')
